            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Theo danh mục</a></li>
                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Theo NSX</a></li>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <form class="form-horizontal" method="POST"  action="admin/san-pham/giam-gia" autocomplete="off">
                      ...
                      @endif
                       <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Tên danh mục chi tiết</label>
                        <div class="col-sm-10">
                  ...
                  <div class="tab-pane" id="timeline">
                      <form class="form-horizontal" method="POST"  action="admin/san-pham/giam-gia" autocomplete="off">
                        @csrf
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Tên NSX</label>
                        <div class="col-sm-10">
